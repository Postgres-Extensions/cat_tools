...
EXTENSION__CURRENT_VERSION__FILES		+= $(EXTENSION_cat_tools_VERSION_FILE)
$(EXTENSION_cat_tools_VERSION_FILE): sql/cat_tools.sql cat_tools.control
	@(echo '/* DO NOT EDIT - AUTO-GENERATED FILE */'; cat sql/cat_tools.sql) > $(EXTENSION_cat_tools_VERSION_FILE)
